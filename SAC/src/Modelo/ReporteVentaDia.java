...
public class ReporteVentaDia {
     ...
     */
    public void setPagoContado(float pagoContado) {
     ...
     */
    public void setVentasNetas(float ventasNetas) {
